...
<body class="body-background <? if ($form == true) print('overlay'); ?>">
  ...
  <div class="page-wrapper">
    <div class="container">
      <header class="main-header">
        <a href="#">
          <img src="../img/logo.png" width="153" height="42" alt="Логoтип Дела в порядке">
        </a>

        <div class="main-header__side">
          <a class="main-header__side-item button button--transparent" href="?category=login">Войти</a>
        </div>
      </header>
  ...
  <div class="modal" <? if ($form != true) print('hidden'); ?>>
    ...
    <form class="form" class="" action="index.php" method="post">
      <div class="form__row">
        ...
        <input class="form__input <?php if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['email'] == '') print ('form__input--error'); ?>"
               type="text" name="email" id="email" value="<?=$email; ?>" placeholder="Введите e-mail">

          <?php if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['email'] == '') print('<p class="form__message">E-mail введён некорректно</p>') ?>
      </div>
